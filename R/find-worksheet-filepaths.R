find_worksheet_filepaths <- function(worksheet,
                                     path = "S:/central shared/Genetics/Repository/WorksheetAnalysedData/",
                                     pattern,
                                     recursive = TRUE,
                                     full_names = TRUE) {
  
  #' Find filepaths for files within worksheet folders 
  #'
  ...
  #'
  #' @returns A list fo worksheet filepaths
  #' @export
  #'
  #' @examples find_worksheet_filepaths(worksheet = "WS157517", pattern = "hrd-results.*csv")
