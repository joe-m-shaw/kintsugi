...
Now the datasets can be joined together for analysis. There are different ways in which the data can be joined: - At the patient level (by NHS number) - At the referral level (by iGene R number) - At the sample level (by DNA lab number)
