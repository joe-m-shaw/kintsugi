...
- Data from somatic variant testing for genetic variants in *BRCA1*, *BRCA2* and 
*TP53*
...
Identify worksheet numbers and file locations for all SeqOne GI testing at the North West GLH.
Results are exported from the SeqOne website as .csv files and saved in folders named after the worksheet identifier.
